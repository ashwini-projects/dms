...
// gulp.task('default', ['watch', 'concat-uglify-js', 'minify-css']);
// gulp.task('default', ['clean', 'concat-uglify-js', 'minify-css', 'lint', 'watch']);
gulp.task('release', ['concat-uglify-js', 'minify-css', 'lint']);
gulp.task('build', ['clean','concat-uglify-js', 'minify-css', 'lint']);
